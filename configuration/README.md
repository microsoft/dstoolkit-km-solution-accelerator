...
```json
{
    ...
    "cogServiceLanguage": "{{config.name}}coglanguage",
    "cogServiceVision": "{{config.name}}cogvision",
    "cogServiceForm": "{{config.name}}cogform",
    "cogServiceTranslate": "{{config.name}}cogtranslate",
