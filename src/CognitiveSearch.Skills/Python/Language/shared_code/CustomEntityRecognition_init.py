...
project_name = os.environ["CNER_PROJECT_NAME"]
deployment_name = os.environ["CNER_DEPLOYMENT_NAME"]
                ...
                formatted_results.append(
                    {
                        ...
                        "data": {#"entities": custom_entities_result.entities,
                                 **{
                                category: [i["text"] for i in custom_entities_result.entities if i["category"] == category]
                                for category in set(i["category"] for i in custom_entities_result.entities)
                                    },
                                 },
