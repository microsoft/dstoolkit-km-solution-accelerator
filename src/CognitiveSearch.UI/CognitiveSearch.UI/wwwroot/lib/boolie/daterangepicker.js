    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(calendar, selected, minDate, maxDate, side) {
            ...
            if (!minDate || minDate.isBefore(calendar.firstDay)) {
                html += '<th class="prev available"><span class="bi bi-arrow-left icon icon-arrow-left glyphicon glyphicon-arrow-left"></span></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar.lastDay)) {
                html += '<th class="next available"><span class="bi bi-arrow-right icon icon-arrow-right glyphicon glyphicon-arrow-right"></span></th>';
            } else {
                html += '<th></th>';
            }
