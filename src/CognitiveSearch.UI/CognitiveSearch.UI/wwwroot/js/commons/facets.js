...
Microsoft.Facets = {
        ...
        for (var i = 0; i < this.static_facets.length; i++) {
            ...
            if (item.includeHomePage) {
                ...
                if (item.rendering === "grid") {
                    ...
                    facetResultsHTML += '</h2>';
                    facetResultsHTML += '<div id="' + nameid + '" class="accordion-collapse collapse" aria-labelledby="' + facetId + '" data-bs-parent="#parent-' + nameid + '">';
                ...
                if (item.type === "daterange") {
                    ...
                    if (item.values && item.values.length > 0) {
                        item.values.forEach(function (item2, index2, array) {
                            ...
                            var facetid = Microsoft.Utils.jqid(nameid + "_" + Microsoft.Facets.EncodeFacetValue(item2.value).replaceAll("=", ""));
        ...
        if (facets) {
            ...
            ordered_keys.forEach((item, idx) => {
                ...
                if (keepOpen) {
                    ...
                    facet_html += '<div id="' + nameid + '" class="accordion-collapse collapse" aria-labelledby="' + facetId + '" data-bs-parent="#' + rendering_type + '-facets-accordion">';
                }
    ...
    EncodeFacetValue: function (value) {
