    ...
    render_table_result: function (docresult, target_tag_id) {
        ...
        if (path !== null) {
            ...
            if (Microsoft.Utils.images_extensions.includes(pathExtension)) {
                ...
                resultsHtml += '   <img alt="' + name + '" class="image-result" src="/api/document/getcoverimage?id=' + document_key + '" title="' + docresult.metadata_storage_name + '"onError="this.onerror=null;this.src=\'' + iconPath + '\';"/>';
            }
