        ...
        if (results && results.length > 0) {
            ...
            for (var i = 0; i < results.length; i++) {
                ...
                if (path !== null) {
                    ...
                    resultsHtml += '<img class="document-carousel-item-image" src="/api/search/getdocumentcoverimage?id=' + docresult.document_id + '" onError="this.onerror=null;this.src=\'' + iconPath + '\';"/>';
